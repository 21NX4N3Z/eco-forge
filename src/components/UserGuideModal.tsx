      ...
      >
        ...
        <div className="hero-mint px-5 py-4 border-b border-line flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-[12px] text-ink-soft mt-0.5">MATEKEYCBAM — เริ่มคำนวณ CBAM ได้ใน 6 ขั้นตอน</div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
          ...
          <section>
            ...
            <p className="text-[12.5px] text-ink-soft mb-3 leading-relaxed">
              ก่อนเริ่มใช้ MATEKEYCBAM รวบรวมข้อมูลเหล่านี้จากฝ่ายผลิต / จัดซื้อ / วิศวกรรม
