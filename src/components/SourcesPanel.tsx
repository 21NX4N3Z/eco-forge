...
export default function SourcesPanel() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card">
        <div className="label mb-3">การรับรอง &amp; มาตรฐาน — สถานะ MATEKAYCBAM</div>
        ...
        <div className="mt-3 text-xs text-ink-mute">
          💡 dSURE = ตรารับรองผลิตภัณฑ์ดิจิทัลของ depa (Security/Safety/Functionality) — MATEKAYCBAM วางแผนสมัครเพื่อสร้างความเชื่อมั่นให้ SME ที่ส่งข้อมูลโรงงาน
        </div>
      </div>

      <div className="card">
        <div className="label mb-1">แหล่งอ้างอิงทั้งหมด — ทุกตัวเลขใน MATEKAYCBAM ย้อนกลับถึงเอกสารทางการ</div>
