...
function SdgInline() {
  return (
    <div style={{ display: 'flex', gap: 4 }}>
      <span style={{ background: '#fbbf24', color: '#000', borderRadius: 4, padding: '0 4px', fontSize: 10 }}>SDG 9</span>
      <span style={{ background: '#34d399', color: '#000', borderRadius: 4, padding: '0 4px', fontSize: 10 }}>SDG 12</span>
      <span style={{ background: '#22d3ee', color: '#000', borderRadius: 4, padding: '0 4px', fontSize: 10 }}>SDG 13</span>
    </div>
  )
}
