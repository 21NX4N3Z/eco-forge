# MATEKAYCBAM — งานตัดสินช่วงสุดท้าย: ใครทำอะไร
...
| งาน | สถานะ |
|---|---|
| Overlay asset 22 ชิ้น green screen | ✅ matekaycbam.vercel.app/overlays.html |
...
4. Export 1080p H.264 → `MATEKAYCBAM_Demo_3min_TME_KMUTT.mp4`
5. **ส่งกลับมาให้ OWL review ก่อนอัปโหลด**

## 🔁 กระบวนการรีวิว (สำคัญ)
- ตัดเสร็จ → ทิ้งไฟล์ .mp4 ไว้ที่ `D:\hermes-workspace\matekaycbam\tmp\review\` แล้วบอก OWL
